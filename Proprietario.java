...
*/
    ...
    // Possibilidade de atualização de endereço provavelmente será requisitada mais pra frente. Por isso, criei um método para isso.
    ...
    public static void main(String[] args) {
        Proprietario proprietario = new Proprietario("João", "12345678901", "123456789", "12345678", "SP", "São Paulo", "Rua dos Bobos", 0);
        proprietario.addImovel(new Imovel("12345578", "SZ", "São Paulo", "Rua dos Bobos", 0, "Casa", "Estadia", 123.50F));
        proprietario.addImovel(new Imovel("12345578", "Rua dos Bobos", 0, "Casa", "Estadia", 123.50F));
        proprietario.addImovel(new Imovel("12345578", "SP", "São Paulo", "Rua dos Bobos", 0, "Apartamento", "Estadia", 123.50F));
