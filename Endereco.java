/* Classe responsável ṕor armazenar um endereço.
 A classe Endereco é uma classe de apoio, que não será instanciada diretamente, mas sim por meio de uma instância de Proprietario ou Imovel.
*/
...
/* TESTE
    public static void main(String[] args) {
        Endereco endereco = new Endereco("12345678", "BA", "Salvador", "Rua 1", 1);
